...
- [x] **PR8**: Public status page ([#20](https://github.com/suporterfid/statusconnect/issues/20)) â€” merged via [PR #21](https://github.com/suporterfid/statusconnect/pull/21); Blade/JSON cached snapshots, ETag/304, MySQL IP limiting, and disclosure/locale coverage verified with 134 tests / 392 assertions.
- [ ] **PR9**: Notifications
