...
| **PR4** | Scheduler core (sequential) | In remediation | [#5](https://github.com/suporterfid/statusconnect/issues/5) | Corrective branch implements `monitor:check-due`, portable conditional claim leases, claim-time drift scheduling, TickBudget, checker/maintenance heartbeats, and stale-claim recovery. Fresh verification: 54 tests / 113 assertions. PR5 remains blocked until this PR is merged. |
