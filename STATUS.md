...
| **PR4** | Scheduler core (sequential) | In remediation | [#5](https://github.com/suporterfid/statusconnect/issues/5) | Corrective branch implements `monitor:check-due`, portable conditional claim leases, claim-time drift scheduling, TickBudget, checker/maintenance heartbeats, stale-claim recovery, and claim-token fencing. Fresh verification: 58 tests / 121 assertions. PR5 remains blocked until this PR is merged. |
